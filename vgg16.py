...
if __name__ == '__main__':
    ...
    num_image_zhang = 0
    for i in range(len(os.listdir('./all_images/')) - 1):
        num_image_zhang = num_image_zhang + 1
        img_raw = imread("./all_images/" + str(num_image_zhang) + ".jpg", mode='RGB')
        ...
        if num_image_zhang != 1:
            img_raw_last = imread("./all_images/" + str(num_image_zhang - 1) + ".jpg", mode='RGB')
